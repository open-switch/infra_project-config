...
# refs/meta/openswitch/release.  Because it's not under refs/heads, a
...
# push directly to refs/meta/openswitch/*.

GIT_HOST="review.openswitch.io:29418"
PROJECT_PREFIX="openswitch"
...
# Checkout or create the meta/openswitch/release branch
if ! { git branch -a |grep ^[[:space:]]*remotes/meta/openswitch/release$; }
then
    ...
    git checkout -b release remotes/meta/openswitch/release
fi
...
git push origin HEAD:refs/meta/openswitch/release
