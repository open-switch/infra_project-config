...
# refs/meta/openhalon/release.  Because it's not under refs/heads, a
...
# push directly to refs/meta/openhalon/*.

GIT_HOST="review.openhalon.io:29418"
PROJECT_PREFIX="openhalon"
...
# Checkout or create the meta/openhalon/release branch
if ! { git branch -a |grep ^[[:space:]]*remotes/meta/openhalon/release$; }
then
    ...
    git checkout -b release remotes/meta/openhalon/release
fi
...
git push origin HEAD:refs/meta/openhalon/release
